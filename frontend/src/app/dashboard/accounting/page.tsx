...
export default function AccountingPage() {
  ...
  // Completed transactions receipt preview state
  ...
  const loadLedgerData = useCallback(async () => {
    ...
    try {
      ...
      const shareRes = await api.get(`/accounts/share-capital/${selectedMemberId}`);
  ...
  return (
    <div className="space-y-6 animate-micro-elevate">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="font-body text-xs text-neutral-600 dark:text-neutral-400">
            Monitor member equity contributions and share capital transactions.
          </p>
        </div>
      ...
      {/* MODAL 5: COMPLETED CONTRIBUTION RECEIPT PREVIEW */}
