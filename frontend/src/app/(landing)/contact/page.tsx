            ...
            {submitted ? (
              <div className="text-center py-12 space-y-4">
                ...
                <p className="font-body text-xs text-neutral-600 dark:text-neutral-400 max-w-xs mx-auto">
                  Thank you! Your message has been sent to our administrative office staff. We will reply to your registered email address shortly.
                </p>
                <button
                  onClick={() => setSubmitted(false)}
                  className="px-6 py-2 bg-primary dark:bg-secondary text-white dark:text-neutral-950 text-xs font-bold rounded-full transition-transform active:scale-95"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4 text-xs">
                ...
                <div className="space-y-1.5">
                  ...
                  <input
                    ...
                    className="w-full px-3.5 py-2.5 bg-neutral-50 dark:bg-neutral-800 border border-outline-variant rounded-xl focus:ring-1 focus:ring-primary outline-none"
                  />
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <textarea
                    ...
                    className="w-full px-3.5 py-2.5 bg-neutral-50 dark:bg-neutral-800 border border-outline-variant rounded-xl focus:ring-1 focus:ring-primary outline-none resize-none font-body"
                  />
                </div>

                <button
                  type="submit"
                  className="w-full py-3 bg-primary dark:bg-secondary text-white dark:text-neutral-950 font-label font-bold rounded-xl shadow hover:translate-y-[-1px] transition-all flex items-center justify-center gap-1.5 cursor-pointer"
                >
